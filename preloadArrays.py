...
Saving arrays locally to later use
...
def saveData():
    ...
    # Save Data
    #===========================================
    header = ["sharedMotionList", "moveDirList", "groupingHoriList","groupElementsShapeList", "cardinalChangeList", "targetShapeLocList", "targetHoriList", "targetMoveDirList", "targetShapeList", "targetExistenceList",    "groupingElementsSpeedList", "targetSpeedList" , "delayTimeList" ]
    rows = zip(sharedMotionList, moveDirList, groupingHoriList, groupElementsShapeList, cardinalChangeList, targetShapeLocList, targetHoriList, targetMoveDirList, targetShapeList, targetExistenceList,     groupingElementsSpeedList, targetSpeedList, delayTimeList)
